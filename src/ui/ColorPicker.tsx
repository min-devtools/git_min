...
/** Modal grid of the eight repository colors. Picking one selects and closes in a single click. */
export function ColorPicker({
  ...
  return (
    <div className="modal" onMouseDown={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="prompt-dialog" role="dialog" aria-modal="true" aria-label="Repository color">
        <strong>Repository color</strong>
        <p className="prompt-dialog-msg">Shows as the dot on every tab using this repository.</p>
